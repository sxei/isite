...
{
    /**
     * 将all_city_codes转换成可以级联展示的格式，也就是省、市、县分开
     */
    getCityMap: function(cityCodes)
    {
        var result = {};
        for(var i in cityCodes)
        {
            ...
            {
                result[i] = {value: cityCodes[i], children: {}};
            }
            else if(i.substring(4) == '00')
            {
                result[i.substring(0, 2)+'0000']['children'][i] = {value: cityCodes[i], children: {}};
            }
            else
            {
                result[i.substring(0, 2)+'0000']['children'][i.substring(0, 4)+'00']['children'][i] = {value: cityCodes[i]};
            }
        }
        return result;
    },
    ...
    getAllCuntys: function(cityCodes)
    {
        ...
        for(var i in cityCodes)
        {
            ...
            if(t2 != '00' && t3 != '00')
            {
                t1 = cityCodes[t1+'0000'];
                t2 = cityCodes[i.substring(0, 4)+'00'];
                t3 = cityCodes[i];
                if(t2 == '县') t2 = ''; // 如果是直辖市，二级可以直接忽略
                cuntys[i] = t1 + t2 + t3;
            }
        }
        return cuntys;
